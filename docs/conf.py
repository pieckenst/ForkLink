...
extensions = ["sphinx.ext.autodoc",
              "sphinx.ext.extlinks", "sphinxcontrib.asyncio"]
...
latex_documents = [
    (master_doc, "forklink.tex", "forklink Documentation", "forklink", "manual"),
]
...
man_pages = [(master_doc, "forklink", "forklink Documentation", [author], 1)]
